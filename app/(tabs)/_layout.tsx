...
export default function TabLayout() {
  return (
      ...
      <ThemeProvider value={DefaultTheme}>
        ...
        <Tabs.Screen name="summary" options={{ title: 'SummARY', headerShown: true, tabBarItemStyle: { title: 'no' ,display: "none" },tabBarIcon: ({ color }) => <MaterialIcons size={28} name="sports-score" color={color} />, }} />
        </Tabs>
    </ThemeProvider>
